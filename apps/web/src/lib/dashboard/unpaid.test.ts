  ...
  const rows: UnpaidAppRow[] = [
    {
      ...
      deliveryDate: "2026-08-10", // 출고의뢰서 설치일시 기준(의뢰 단위)
      quotes: [
        { version: 1, status: "issued", supply_price: "1000000" },
        { version: 2, status: "issued", supply_price: "1500000" }, // 대표(최신)
      ],
    },
    {
      id: "a2", seq_no: "REQ-2", company: "다라상사", status: "collecting", assigneeName: null,
      deliveryDate: null,
      quotes: [{ version: 1, status: "issued", supply_price: 3000000 }],
    },
  ];
  ...
  test("발행 견적 없으면(임시만) 금액 0", () => {
    const r = buildUnpaidSummary([
      { id: "x", seq_no: "REQ-9", company: "임시사", status: "delivered", assigneeName: null,
        deliveryDate: null,
        quotes: [{ version: 1, status: "draft", supply_price: "500000" }] },
    ]);
