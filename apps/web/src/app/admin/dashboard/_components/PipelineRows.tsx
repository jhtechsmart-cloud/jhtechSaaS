...
export function PipelineRows({
  ...
  return (
    <section className="flex flex-col gap-3 rounded-2xl border border-border bg-surface p-6 shadow-card">
      <p className="text-h2 font-semibold text-text">견적 파이프라인</p>
      ...
      {staleCount > 0 && (
        <p className="rounded-lg border border-coral bg-coral-soft px-3 py-2 text-small font-medium text-coral-text">
