...
- **중립:** bg/사이드바 `#F3F8F6` · 카드 `#FFFFFF` · 보조표면 `#EEF5F2` · 보더 `#DFEAE5` · 행 구분선 `#ECF3F0` · 본문 `#21413A` · 보조 `#4D6B63` · 흐림 `#92ACA4`(faint — 작은 본문 금지, AA 미달) · **muted-foreground `#5E7C73`**(AA 4.6:1 조정값) · 빈 값 `#C8D8D2`.
